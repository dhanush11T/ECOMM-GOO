 ...
 const [scroll,setScroll] = useState(0)
  ...
  return (
    <div  className='container mx-auto px-4 my-6 relative'>
           ...
           <div  id="card2" className='flex items-center gap-4 md:gap-6 overflow-scroll scrollbar-none transition-all' ref={scrollElement}>
           ...
           {   loading ? (
                loadingList.map((product,index)=>{
                    return(
                        <div className='w-full min-w-[270px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow  flex'>
                    ...
                    <Link to={"product/"+product?._id} id="scard" className='w-full min-w-[290px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-38 bg-white rounded-sm shadow flex'>
                        ...
                        <div className='p-9 grid'>
                            ...
                            <div className='flex wrap gap-2'>
                                ...
                                <p className='text-slate-500 font-light line-through'>{ displayINRCurrency(product?.price)  }</p>
                            </div>
                            <button id="comic-button" className='text-xs bg-red-600 hover:bg-red-700 text-white px-9 py-0.5 rounded-full' onClick={(e)=>handleAddToCart(e,product?._id)}>Add to Cart</button>
                        </div>
                    </Link>
                )
            })
